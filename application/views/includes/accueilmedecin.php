...
<html>
    ...
    <body>
        ...
        <?php 
            require ('../application/views/includes/includes/header_bar.php');

            if ($_SESSION['type'] == 1) 
                    require '../application/views/includes/topbar-navigation.php';    
            

            require ('../application/views/includes/includes/password_modal.php');
                 ...
                 <div class="row" >
                    <div class="col-sm-4 col-xs-12">
                        <div class="card card-block text-xs-center">
                            <a href="index.php?page=lastrec&table=anapath" class="thumb">
                             <img src="../application/views/assets/images/gallery/01.png" alt="Histologie" class="card-img-bottom img-fluid thumb-img"></a>
                            <a href="index.php?page=lastrec&table=anapath" class="btn btn-purple m-t-2">Histologie</a>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 col-xs-12">
                        <div class="card card-block text-xs-center">
                            ...
                            <a href="index.php?page=lastrec&table=frottismilieuliquide" class="thumb">
                            <img src="../application/views/assets/images/gallery/02.png" alt="Frottis en milieu liquide" class="card-img-bottom img-fluid thumb-img"></a>
                            <a href="index.php?page=lastrec&table=frottismilieuliquide" class="btn btn-secondary m-t-2">Frottis en milieu liquide</a>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4 col-xs-12">
                        <div class="card card-block text-xs-center">
                            ...
                            <a href="index.php?page=lastrec&table=frottisvaginal" class="thumb">
                            <img src="../application/views/assets/images/gallery/03.png" alt="Frottis Vaginal" class="card-img-bottom img-fluid thumb-img"></a>
                            <a href="index.php?page=lastrec&table=frottisvaginal" class="btn btn-custom m-t-2">Frottis Vaginal</a>
                        </div>
                    </div>
                    <div class="col-sm-4 col-xs-12">
                        <div class="card card-block text-xs-center">
                            
                            <a href="index.php?page=lastrec&table=myelogramme" class="thumb">
                             <img src="../application/views/assets/images/gallery/04.png" alt="Myelogramme" class="card-img-bottom img-fluid thumb-img"></a>
                            <a href="index.php?page=lastrec&table=myelogramme" class="btn btn-purple m-t-2">Myelogramme</a>
                        </div>
                    </div>
                    <div class="col-sm-4 col-xs-12">
                        <div class="card card-block text-xs-center">
                            <a href="index.php?page=lastrec&table=spermogramme" class="thumb">
                            <img src="../application/views/assets/images/gallery/05.png" alt="Spermogramme" class="card-img-bottom img-fluid thumb-img"></a>
                            <a href="index.php?page=lastrec&table=spermogramme" class="btn btn-secondary m-t-2">Spermogramme</a>

                        </div>
                    </div>
                    <div class="col-sm-4 col-xs-12">
                        <div class="card card-block text-xs-center">
                            <a href="index.php?page=lastrec&table=coital" class="thumb">
                            <img src="../application/views/assets/images/gallery/06.png" alt="Test Post Coital" class="card-img-bottom img-fluid thumb-img"></a>
                            <a href="index.php?page=lastrec&table=coital" class="btn btn-custom m-t-2">Test Post Coital</a>
                        </div>
                    </div>
                </div>
