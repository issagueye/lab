                    ...
                    <table class="table table-hover" id="tabSpermo">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input class="dah" type="number" name="tdr1" value="<?php if (isset($recup)) {
                echo $recup->tdr1;} ?>" class="form-control" min="0" max="100" step=""><span>%</span></td>
                                <td>!</td>
                                <td><input class="dah" type="number" name="tdr4" value="<?php if (isset($recup)) {
                echo $recup->tdr4;} ?>" class="form-control" min="0" max="100" step=""><span>%</span></td>
                            <td>!</td>
                           <td><input class="dah" type="number" name="tdr24" value="<?php if (isset($recup)) {
                echo $recup->tdr24;} ?>" class="form-control" min="0" max="100" step=""><span>%</span></td>
                                </tr>
                                
                            <tr>
                                <td>Mobilité Diminuée</td>
                                <td><input class="dah" type="number" name="mobd1" value="<?php if (isset($recup)) {
                echo $recup->mobd1;} ?>" class="form-control" min="0" max="1000" step=""><span>%</span></td>
                                <td>!</td>
                                <td><input class="dah" type="number" name="mobd4" value="<?php if (isset($recup)) {
                echo $recup->mobd4;} ?>" class="form-control" min="0" max="100" step=""><span>%</span></td>
                            <td>!</td>
                                <td><input class="dah" type="number" name="mobd24" value="<?php if (isset($recup)) {
                echo $recup->mobd24;} ?>" class="form-control" min="0" max="100" step=""><span>%</span></td>
                            </tr>
                            <tr>
                                <td>Immobile</td>
                                <td><input class="dah" type="number" name="immo1" value="<?php if (isset($recup)) {
                echo $recup->immo1;} ?>" class="form-control" min="0" max="100" step=""><span>%</span></td>
                                <td>!</td>
                                <td><input class="dah" type="number" name="immo4" value="<?php if (isset($recup)) {
                echo $recup->immo4;} ?>" class="form-control" min="0" max="100" step=""><span>%</span></td>
                        <td>!</td>
                                <td><input class="dah" type="number" name="immo24" value="<?php if (isset($recup)) {
                echo $recup->immo24;} ?>" class="form-control" min="0" max="100" step=""><span>%</span></td>
                            </tr>
                        </tbody>
                    </table>
                </div><br>
...
<style>
    table th:nth-child(1), table td:nth-child(1),table th:nth-last-child(1), table td:nth-last-child(1),th:nth-child(1), table td:nth-child(1)
    {
        position: relative;
        width: 20%;
    }
