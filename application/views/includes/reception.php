        ...
        <div class="wrapper">
            <div class="container">
                ...
                <?php 
                 ...
                 ?>
                    <h4 class="display-4 m-t-70">Derniers enregistrements: <?php echo $texte; ?></h4>
                    <a href="index.php?page=formrecep&type=<?php echo $type; ?>" target="blank">
                    <button class="btn btn-primary ">Ajouter un enregistrement</button>
                    </a>
                    <a href="index.php?page=archives&type=<?php echo $type; ?>" target="blank">
                    <button class="btn btn-dark" href="">Consulter les archives</button>
                    </a>
                    ...
                    <div class="col-xs-12">
                        <div class="card-box">
                            <div class="table-rep-plugin">
                                    ...
                                    <table id="datatable" class="table table-striped table-bordered" style="width:100%;" width="100%" cellspacing="0">
                                        <thead class="thead-default">
                                            <tr>
                                                ...
                                                <th data-priority="1" width="7%">Age</th>
                                                <th width="17%" data-priority="2">Date de prelevement</th>
                                                <th data-priority="6" width="5%">Service</th>
                                                <th data-priority="2" width="15%">Examen demandé </th>
                                                <th data-priority="3" width="2">Nomenclature</th>
                                                <th data-priority="1" width="30%">Options</th>
                                            </tr>
                                        </thead>
                                         <tbody>
                                         <?php 
                                         include 'includes/connectDb.php';
                                         $req = $bdd->query("SELECT * FROM analyses WHERE status!=1 AND status!=2 AND recep='$type'");
                                         ...
                                         foreach ($donnees as $key => $value) {
                                          ...
                                          ?>
                                            <tr>
                                                ...
                                                <td><?php 
                                                    if ($value->agePatient == 0)
                                                        echo "?";
                                                    else
                                                        echo $value->agePatient." ".$value->nb;
                                                ?></td>
                                                <td><?php 
                                                    if (date('d-m-Y',strtotime($value->datePrelevement)) == "01-01-1970")
                                                        echo "?";
                                                    else
                                                        echo date('d-m-Y',strtotime($value->datePrelevement)) ?></td>
                                                <td><?php echo $value->service ?></td>
                                                <td><?php echo $value->medecinTraitant ?></td>
                                                <td><?php echo $value->nomenclature ?></td>
                                                <td><a href="index.php?page=formrecep&type=<?php echo $type ?>&id=<?php echo $value->idAna ?>"><button class="btn"><i class="zmdi zmdi-edit" title="Modifier"></i></button></a>

                                <a href="index.php?page=archive&id=<?php echo $value->idAna ?>&table=<?php echo $type ?>&type=recep" target="blank"><button onclick="return archiver()" class="btn "><i class="zmdi zmdi-archive" title="Archiver"></i></button></a> 
                                ...
                                <a href="index.php?page=imprimer&recep=1&type=<?php echo $type ?>&id=<?php echo $value->idAna ?>" target="blank"><button class="btn "><i class="zmdi zmdi-print" title="Imprimer"></i></button></a>
                                
                                <a href="index.php?page=delete&id=<?php echo $value->idAna ?>&table=<?php echo $type ?>&type=recep"><button onclick="return supprimer()" class="btn"><i class="zmdi zmdi-delete" title="Supprimer" ></i></button></a></td>
