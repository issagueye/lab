...
<head>
	...
	<link rel="stylesheet" href="../Application/views/css2/pages.css">
	...
	<br><br>
		...
		<div class="row" id="entete">
			...
			<div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">	
				...
				<label for="">Date de sortie :</label> <?php echo date('Y-m-d',strtotime($donnees->dateSortie)) ?><br>
			</div>
