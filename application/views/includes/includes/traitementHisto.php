<?php 
		...
		if (isset($_POST['otherS']) and $_POST["otherS"] != null) {
						...
						$req = $bdd->prepare("INSERT INTO analyses (typeAna,nomPatient,prenomPatient,agePatient,nb,sexe,medecinTraitant,service,codeAna,numExam,datePrelevement,dateSortie,naturePrelevement,renseignementsCliniques,dateCompteRendu,transmisA,interpretations,conclusion,medecinSaisie,status) VALUES ('anapath',:nom,:prenom,:age,:nb,:sexe,:medTraitant,:service,:codeAna,:numero,:dateP,:dateS,:nature,:rens,:datecptr,:transmis,:interp,:conclusion,:medecinSaisie,0)");
					...
					$modif = $bdd->prepare("UPDATE analyses SET
						...
						conclusion=:conclusion,
						medecinSaisie = :medecinSaisie WHERE idAna='".$_GET['id']."' ");
					...
					if ($modif->execute(array(
						...
						echo "<script>alert('modif réusssie')</script>";
