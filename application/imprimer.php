...
<?php
			...
			<p>
                ...
                Insler  7 = glaire "non fonctionnelle" (inadéquate)</strong>
                </p>
             <p>
             	<strong>Nombre de spermatozoïdes/champs</strong>
             	<ul>
             		<li><?php if ($donnees->nbSC == 0) echo "<strong>"; ?>0<?php if ($donnees->nbSC == 0) echo "</strong>"; ?></li>
             		<li>Pauvre: moins de 5</li>
             		<li>Satisfaisant: 20 à 50</li>
             		<li>Normal: >50</li>
             	</ul>
             	<strong>Degré de mobilité</strong>
             	<ul>
             		<li>Progression en diagonale(N)</li>
             		<li>Sur place, oscillants</li>
             		<li>Nul</li>
             	</ul>
             	<strong>Présence d'agglutinats(possibilité d'anticorps)</strong> oui / non
             </p><br>
...
?>
		...
		<table id="corps">
			...
			<tr>
				<td><strong>ABSTINENCE : </strong><?php echo $donnees->abstinence ?></td>
				<td><strong style="margin-left: -50px;">VOLUME : </strong> <?php echo $donnees->volume ?></td>
		...
		<table>
			...
			<tr>
				<td><strong>CYTOLOGIE:</strong><br><span style="margin-left:50px;">Agglutination en amas: </span><br><span style="margin-left:50px;">Formes anormales (en %) : </span><?php echo $donnees->formesAnormales ?></td>
			</tr>
			<tr>
				<td>
			...
			<tr>
				<td>
					<strong>Conclusion : <br><?php echo $donnees->codeAna ?></strong>
